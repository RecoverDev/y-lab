...
CREATE SEQUENCE habit.logbook_id_seq START 1;
...
INSERT INTO habit.logbook (id, habit_id, date) VALUES
(nextval('habit.logbook_id_seq'),1,DATE('2014-10-10')),
(nextval('habit.logbook_id_seq'),1,DATE('2014-10-11')),
(nextval('habit.logbook_id_seq'),1,DATE('2014-10-12')),
(nextval('habit.logbook_id_seq'),1,DATE('2014-10-13')),
(nextval('habit.logbook_id_seq'),1,DATE('2014-10-14')),
(nextval('habit.logbook_id_seq'),2,DATE('2014-10-01')),
(nextval('habit.logbook_id_seq'),2,DATE('2014-10-08')),
(nextval('habit.logbook_id_seq'),3,DATE('2014-10-12')),
(nextval('habit.logbook_id_seq'),3,DATE('2014-10-19')),
(nextval('habit.logbook_id_seq'),4,DATE('2014-10-08')),
(nextval('habit.logbook_id_seq'),4,DATE('2014-10-09')),
(nextval('habit.logbook_id_seq'),4,DATE('2014-10-10'));